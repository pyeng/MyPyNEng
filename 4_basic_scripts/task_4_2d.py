...
device = raw_input("\nEnter device name: ").lower()
prompt = "\nEnter parameter name {}: ".format(london_co[device].keys())
parameter = raw_input(prompt).lower()
device_dict = london_co[device]
print 
print device_dict.get(parameter, "Такого параметра нет")
